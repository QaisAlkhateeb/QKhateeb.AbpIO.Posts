...
public class ContributorPatternExampleDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ContributorPatternExampleDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
